                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(Auth::user()->can('services.edit'))
                                                <a href="{{ route('edit.services', $item->id) }}" class="btn btn-primary waves-effect waves-light">
                                                    <i class="fa-solid fa-pen"></i>  
                                                </a>
                                            @endif

                                            @if(Auth::user()->can('services.delete'))
                                                <a href="{{ route('delete.services', $item->id) }}" class="btn btn-danger waves-effect waves-light" id="delete">  
