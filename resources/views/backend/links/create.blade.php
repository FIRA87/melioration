                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" id="url" name="url"  autofocus="">
                                    </div>

                                    <div class="mb-3 ">
                                        <label for="img" class="form-label">Изображение *</label>
                                        <input class="form-control" type="file" id="img" name="img"  autofocus="">
                                    </div>
                                  ...
                                  <div class="col-md-12">
                                       <div class="form-group mb-3">
                                           ...
                                           <select class="form-select"  name="status" aria-invalid="false" style="display: block" id="status">
