            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form id="myForm" method="POST" action="{{ route('store.gallery') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group col-md-6 my-3">
                                        <label for="images" class="form-label">Картинки галереи (можно выбрать
                                            несколько изображений)</label>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane" id="home-b1" role="tabpanel">
                                                <textarea id="summernote" name="text_ru" id="home-b1" cols="107" rows="10">{{ old('text_ru', 'ТЕКСТ [RU]') }}</textarea>
                                            </div>
                                            <div class="tab-pane show" id="profile-b1" role="tabpanel">
                                                <textarea id="summernote2" name="text_tj" id="profile-b1" cols="107" rows="10">{{ old('text_tj', 'ТЕКСТ [TJ]') }}</textarea>
                                            </div>
                                            <div class="tab-pane active" id="messages-b1" role="tabpanel">
                                                <textarea id="summernote3" name="text_en" id="messages-b1" cols="107" rows="10">{{ old('text_en', 'ТЕКСТ [EN]') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
