                        ...
                        <div class="card-body">
                            <h4 class="header-title">Редактировать галерею</h4>
                                <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <form action="/deletecover/{{ $gallery->id }}" method="POST" >
                                                ...
                                                <div class="form-group col-md-6 my-3">
                                                    ...
                                                    <img src="/upload/cover/{{ $gallery->cover }}" alt="" style="max-height: 150px; max-width: 150px" class="img-fluid rounded my-2">
                                               ...
                                               @if(count($gallery->images) > 0 )
                                                    ...
                                                    @foreach ($gallery->images as $item)
                                                        <form action="/deleteimage/{{ $item->id }}" method="POST">
                                                            @csrf
                                                            @method('delete')
                                                            <button class="btn btn-danger d-flex" style="position:relative; left:35%">Удалить</button>
                                                            <img src="/upload/gallery/{{ $item->image }}" alt="" style="max-height: 150px; max-width: 150px" class="img-fluid rounded  m-2" >
                                                        </form>
                                                    @endforeach
                                    ...
                                    <form method="POST" action="{{ url('/gallery/update/'.$gallery->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('put')
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group col-md-6 my-3">
                                                    <label for="images" class="form-label">Новые картинки (можно выбрать несоклько изображений)</label>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" id="title_ru" class="form-control" name="title_ru" value="{{ $gallery->title_ru }}">
                                            </div>
                                            <div class="form-group mb-3">
                                                <label for="title_tj" class="form-label">Название TJ</label>
                                                <input type="text" id="title_tj" name="title_tj" class="form-control"  value="{{ $gallery->title_tj }}">
                                            </div>

                                            <div class="form-group mb-3">
                                                <label for="title_en" class="form-label">Название EN</label>
                                                <input type="text" id="title_en" name="title_en" class="form-control" value="{{ $gallery->title_en }}" >
                                            </div>
