        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Разрешение роли</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Добавить разрешение для роли</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class=" form-group mb-3">
                                            ...
                                            <select class="form-select" id="group_name" name="role_id">
                                  ...
                                  <div class="row">
                                   ...
                                   <div class="row">
                                       ...
                                       <div class="col-2">
                                           ...
                                           <div class="form-check mb-2 form-check-primary">
                                               <input class="form-check-input" name="permission[]" type="checkbox" value="{{ $item->id }}" id="customckeck{{ $item->id }}" >
