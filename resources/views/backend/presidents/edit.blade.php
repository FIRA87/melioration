                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            @if($president->image)
                                                <img src="{{ asset($president->image) }}" alt="{{ $president->title_tj }}" style="width: 100px; height: 100px; object-fit: cover; margin-top: 10px;">
                                            @endif
                                        </div>
                                    </div>
                                            ...
                                            <div class="d-flex align-items-center" style="gap: 8px;">
                                                ...
                                                <div class="form-check form-switch m-0 p-0">
                                                    <input type="checkbox"
                                                           ...
                                                           id="statusCheckbox"
                                                           name="status"
                                                           value="1" {{ $president->status ? 'checked' : '' }}
                                                           style="width: 2.5rem; height: 1.3rem; cursor: pointer;"
                                                        {{ isset($president) && $president->status == 1 ? 'checked' : '' }}>
                                                </div>

                                                <span id="status-label" class="{{ isset($president) && $president->status == 1 ? 'text-success fw-bold' : 'text-muted' }}" style="font-size: 15px;">
                {{ isset($president) && $president->status == 1 ? 'Активный' : 'Неактивный' }}
            </span>
                                            </div>
                                        </div>
                                    </div>
