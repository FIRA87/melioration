                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('add.admin') }}" class="btn btn-blue waves-effect waves-light text-white">
                                    Добавить
                                </a>
                            </li>
                            @endif
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(Auth::user()->can('admin.edit'))
                                            <a href="{{ route('edit.admin', $item->id) }}" class="btn btn-primary waves-effect waves-light">
                                                <i class="fa-solid fa-pen"></i>   
                                            </a>
                                        @endif

                                        @if(Auth::user()->can('admin.delete'))
                                            <a href="{{ route('delete.admin', $item->id) }}" class="btn btn-danger waves-effect waves-light" id="delete">
