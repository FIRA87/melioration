                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('add.submenu') }}"
                                    ...
                                    @foreach ($submenu as $page)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($page['status'] == 1)
                                                    <a class="updatePageStatus" id="page-{{ $page['id'] }}"
                                                        ...
                                                        <i class="fas fa-toggle-on" style="font-size: 34px; color: #3f6ed3"
                                                            status="Active"></i>
                                                    </a>
                                                @else
                                                    <a class="updatePageStatus" id="page-{{ $page['id'] }}"
                                                        page_id="{{ $page['id'] }}" href="javascript:void(0)">
                                                        <i class="fas fa-toggle-off" style="color: gray;font-size: 34px"
                                                            status="InActive"></i>
                                                    </a>
                                                @endif
                                            </td>
                                            <td>
                                                ...
                                                <a href="{{ route('delete.submenu', $page->id) }}"
